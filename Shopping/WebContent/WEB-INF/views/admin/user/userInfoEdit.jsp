										...
										<div class="form-group col-lg-6">
											...
											<c:if test=""></c:if>
												<select name="enabled" class="form-control" >
													<option value="1" <c:if test="${user.enabled==1}">selected</c:if>>激活会员</option>
													<option value="2" <c:if test="${user.enabled==2}">selected</c:if>>冻结会员</option>
												</select>
										</div>
										<div class="form-group col-lg-6">
											<label>注册时间</label>
										...
										<div class="form-group col-lg-6">
											...
											<div>											
												<div class="form-group checkbox checkbox-success checkbox-inline" style="margin-top:3px; margin-bottom: 10px">
														<input type="checkbox" id="permisskey1" name="role" value="ROLE_ADMIN" 
																<c:if test="${user.role=='ROLE_ADMIN'}">checked</c:if>
														>
														<label>管理员</label>
												</div>
												<div class="form-group checkbox checkbox-success checkbox-inline" style="margin-top:3px; margin-bottom: 10px">
														<input type="checkbox" id="permisskey2" name="role" value="ROLE_USER" 
